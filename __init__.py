...
cors = CORS(app, supports_credentials=True, origins=['http://localhost:4100', 'http://127.0.0.1:4100', 'https://motor.stu.nighthawkcoders.github.io', 'https://tvick22.github.io'])
