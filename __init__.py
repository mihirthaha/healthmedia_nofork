...
cors = CORS(app, supports_credentials=True, origins=['http://localhost:8887', 'http://127.0.0.1:8887', 'https://motor.stu.nighthawkcoders.github.io', 'https://tvick22.github.io'])
